<!--
  ...
  templates/infra-implementer.agent.md at that path, delete this comment block, and
  start filling it in. Keep the guidance italics until each section has real content.
-->
...
agent: `.github/agents/infra-implementer.agent.md`
