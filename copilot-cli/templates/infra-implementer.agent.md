<!--
  TEMPLATE — implementation-agent contract (GitHub Copilot CLI format).
  ...
  How to install:
    1. mkdir -p .github/agents          # or your host's agent dir
    2. cp <plugin-dir>/templates/infra-implementer.agent.md \
         .github/agents/infra-implementer.agent.md
